...
#         needed_data = json_data['props']['pageProps']['searchPageState']['cat1']['searchResults']['listResults']

#         # for home in needed_data:
#         #     home_data = {
...
#         next_page_url = json_data['props']['pageProps']['searchPageState']['cat1']['searchList']['pagination'].get('nextUrl', None)

#         if (next_page_url):
#             next_page_full_url = 'https://www.zillow.com/homes/' + json_data['props']['pageProps']['searchPageState']['cat1']['searchList']['pagination'].get('nextUrl',None)
